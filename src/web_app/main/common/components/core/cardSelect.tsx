...
const CardSelect = (props:select) =>{
    return(
        <div className={classJoiner(props.class, "")}>
            <select className={classJoiner("w-full h-full border border-neutral-300 border-solid py-2 px-4 box-border rounded-xl", lato.className)} ref={props.selectRef} onChange={props.change}>
