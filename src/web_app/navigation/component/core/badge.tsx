...
const Badge = (props:badge) =>{
    ...
    return(
        <MenuWrapper class={classJoiner("relative cursor-pointer", props.class)}>
            <MenuContentWrapper>
                {props.count && <div className="rounded-full size-5 flex flex-col justify-center items-center box-border absolute top-0 right-0 bg-dashboard-red text-xs text-white font-bold">{props.count}</div>}
